...
# Parser
parser = argparse.ArgumentParser(prog="ABPc", description="Compute clusters for ABP simulations.")
parser.add_argument(
...
snapshots = shift_in_mainbox(s[:, :, frames]).T
...
for i in tqdm(range(n_iters)):
    ...
    rGS.append(np.array([rG(c) for c in clustered_ss[i]]))
